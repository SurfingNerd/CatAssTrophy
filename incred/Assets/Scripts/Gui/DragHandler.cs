...
namespace Gui
{
    public class DragHandler : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            Debug.Log("OnDrag" + UnityEngine.Camera.main.ScreenToWorldPoint(Input.mousePosition));
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            //960 , 520
            itemToDrag.transform.localPosition = RectTransformUtility.WorldToScreenPoint(UnityEngine.Camera.main, itemToDrag.transform.localPosition);
